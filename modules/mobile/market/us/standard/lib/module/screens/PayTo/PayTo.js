...
export const PayTo = _ref => {
  ...
  const handleChange = value => {
    const filtered = list.filter(contact => JSON.stringify(contact).toLowerCase().includes(value));
  ...
  }, /*#__PURE__*/React.createElement(Header, null), /*#__PURE__*/React.createElement(Title, null, "Pay to"), /*#__PURE__*/React.createElement(InputSearch, {
