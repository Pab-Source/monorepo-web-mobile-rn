...
export const Review = _ref => {
  ...
  return /*#__PURE__*/React.createElement(Container, null, /*#__PURE__*/React.createElement(View, null, /*#__PURE__*/React.createElement(Header, null), /*#__PURE__*/React.createElement(Title, null, "Review")), /*#__PURE__*/React.createElement(ContainerFields, null, fields === null || fields === void 0 ? void 0 : fields.map(field => /*#__PURE__*/React.createElement(Field, {
    key: JSON.stringify(field),
    label: field.label,
    value: field.value
  }))), /*#__PURE__*/React.createElement(ContainerButtons, null, /*#__PURE__*/React.createElement(Button, {
    onPress: () => navigation.navigate('Alert', { ...route.params
    })
  }, "Send payment"), /*#__PURE__*/React.createElement(Button, {
    style: {
      marginTop: 10,
