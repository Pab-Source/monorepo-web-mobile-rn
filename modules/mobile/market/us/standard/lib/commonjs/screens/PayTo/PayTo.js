...
const PayTo = (_ref) => {
  let { contactList = _constants.list, navigation } = _ref;
  const [contacts, setContacts] = (0, _react.useState)(contactList);

  const handleChange = (value) => {
    const filtered = _constants.list.filter((contact) =>
  ...
  return /*#__PURE__*/ _react.default.createElement(
    ...
    /*#__PURE__*/ _react.default.createElement(_components2.Header, null),
    /*#__PURE__*/ _react.default.createElement(
      _components2.Title,
      null,
      'Pay to'
    ),
    /*#__PURE__*/ _react.default.createElement(_components.InputSearch, {
